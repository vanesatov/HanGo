...
import com.example.hango.databinding.ActivityColores10Binding

class Colores10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores10Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores11Activity::class.java)
