...
import com.example.hango.databinding.ActivityColores14Binding

class Colores14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores14Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores14Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores15Activity::class.java)
