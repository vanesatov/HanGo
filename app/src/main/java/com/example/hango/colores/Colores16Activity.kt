...
import com.example.hango.databinding.ActivityColores16Binding

class Colores16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores16Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores17Activity::class.java)
