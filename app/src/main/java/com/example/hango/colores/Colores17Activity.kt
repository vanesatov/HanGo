...
import com.example.hango.databinding.ActivityColores17Binding


class Colores17Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores17Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores18Activity::class.java)
