...
import com.example.hango.databinding.ActivityColores18Binding

class Colores18Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores18Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("Colores19", 19)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoColoresActivity::class.java)
                intent.putExtra("errores", errores.toTypedArray())
                startActivity(intent)
            } else {
                val intent = Intent(this, ColoresFinalActivity::class.java)
                startActivity(intent)
            }
            finish()
        }
