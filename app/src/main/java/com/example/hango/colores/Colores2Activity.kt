...
import com.example.hango.databinding.ActivityColores2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Colores2Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores2Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityColores2Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, Colores3Activity::class.java)
