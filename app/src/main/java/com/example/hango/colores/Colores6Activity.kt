...
import com.example.hango.databinding.ActivityColores6Binding

class Colores6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores6Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores7Activity::class.java)
