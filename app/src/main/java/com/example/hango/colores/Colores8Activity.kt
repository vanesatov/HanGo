...
import com.example.hango.databinding.ActivityColores8Binding

class Colores8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityColores8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityColores8Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Colores9Activity::class.java)
