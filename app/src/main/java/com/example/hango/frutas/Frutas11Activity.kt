...
import com.example.hango.databinding.ActivityFrutas11Binding

class Frutas11Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas11Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas12Activity::class.java)
