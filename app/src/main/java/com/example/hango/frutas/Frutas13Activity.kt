...
import com.example.hango.databinding.ActivityFrutas13Binding

class Frutas13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas14Activity::class.java)
