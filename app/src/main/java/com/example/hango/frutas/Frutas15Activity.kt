...
import com.example.hango.databinding.ActivityFrutas15Binding

class Frutas15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas16Activity::class.java)
