...
import com.example.hango.databinding.ActivityFrutas16Binding


class Frutas16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas16Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("Frutas17", 17)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoFrutasActivity::class.java)
