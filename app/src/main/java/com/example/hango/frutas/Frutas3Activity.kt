...
import com.example.hango.databinding.ActivityFrutas3Binding

class Frutas3Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas3Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas4Activity::class.java)
