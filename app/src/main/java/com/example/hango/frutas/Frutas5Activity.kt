...
import com.example.hango.databinding.ActivityFrutas5Binding

class Frutas5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas6Activity::class.java)
