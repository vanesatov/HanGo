...
import com.example.hango.databinding.ActivityFrutas6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Frutas6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityFrutas6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, Frutas7Activity::class.java)
