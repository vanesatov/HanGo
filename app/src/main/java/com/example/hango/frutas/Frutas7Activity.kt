...
import com.example.hango.databinding.ActivityFrutas7Binding

class Frutas7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityFrutas7Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, Frutas8Activity::class.java)
