...
import com.example.hango.databinding.ActivityFrutas8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Frutas8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityFrutas8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityFrutas8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, Frutas9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.sandia)
        mediaPlayer?.start()
