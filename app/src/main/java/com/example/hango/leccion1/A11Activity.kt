...
import com.example.hango.databinding.ActivityA11Binding

class A11Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA11Binding.inflate(layoutInflater)
