...
import com.example.hango.databinding.ActivityA13Binding

class A13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA13Binding.inflate(layoutInflater)
