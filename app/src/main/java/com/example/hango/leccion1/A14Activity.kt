...
import com.example.hango.databinding.ActivityA14Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class A14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA14Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityA14Binding.inflate(layoutInflater)
