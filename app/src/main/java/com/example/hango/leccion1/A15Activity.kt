...
import com.example.hango.databinding.ActivityA15Binding

class A15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA15Binding.inflate(layoutInflater)
