...
import com.example.hango.databinding.ActivityA17Binding

class A17Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA17Binding.inflate(layoutInflater)
        ...
        binding.btnReproducirAudio.setOnClickListener {
            mediaPlayer?.release()
            mediaPlayer = MediaPlayer.create(this, R.raw.letra_yeo)
            mediaPlayer?.start()
        }
