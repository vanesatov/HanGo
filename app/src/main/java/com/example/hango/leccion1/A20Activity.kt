...
import com.example.hango.databinding.ActivityA20Binding

class A20Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA20Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("A21", 21)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                ...
                val intent = Intent(this, AFinalActivity::class.java)
                startActivity(intent)
            }
            finish()
        }
