...
import com.example.hango.databinding.ActivityA4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class A4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityA4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, A5Activity::class.java)
