...
import com.example.hango.databinding.ActivityA5Binding

class A5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, A6Activity::class.java)
