...
import com.example.hango.databinding.ActivityA6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class A6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityA6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, A7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_o)
        mediaPlayer?.start()
