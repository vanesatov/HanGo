...
import com.example.hango.databinding.ActivityA7Binding

class A7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA7Binding.inflate(layoutInflater)
        ...
        binding.btnReproducirAudio.setOnClickListener {
            mediaPlayer?.release()
            mediaPlayer = MediaPlayer.create(this, R.raw.letra_u)
            mediaPlayer?.start()
        }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, A8Activity::class.java)
