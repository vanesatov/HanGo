...
import com.example.hango.databinding.ActivityA8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class A8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityA8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, A9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_eo)
        mediaPlayer?.start()
