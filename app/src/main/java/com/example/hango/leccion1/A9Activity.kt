...
import com.example.hango.databinding.ActivityA9Binding

class A9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityA9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityA9Binding.inflate(layoutInflater)
