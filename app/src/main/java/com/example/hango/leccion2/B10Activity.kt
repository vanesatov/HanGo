...
import com.example.hango.databinding.ActivityB10Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class B10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB10Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityB10Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, B11Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_wae)
        mediaPlayer?.start()
