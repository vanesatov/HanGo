...
import com.example.hango.databinding.ActivityB12Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class B12Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB12Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityB12Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, B13Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_oe)
        mediaPlayer?.start()
