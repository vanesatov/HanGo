...
import com.example.hango.databinding.ActivityB13Binding

class B13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B14Activity::class.java)
