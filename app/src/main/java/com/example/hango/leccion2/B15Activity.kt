...
import com.example.hango.databinding.ActivityB15Binding

class B15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B16Activity::class.java)
