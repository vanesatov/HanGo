...
import com.example.hango.databinding.ActivityB18Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class B18Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB18Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityB18Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, B19Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_wi)
        mediaPlayer?.start()
