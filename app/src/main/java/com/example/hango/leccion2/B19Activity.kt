...
import com.example.hango.databinding.ActivityB19Binding

class B19Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB19Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB19Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B20Activity::class.java)
