...
import com.example.hango.databinding.ActivityB20Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class B20Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB20Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityB20Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, B21Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_ui)
        mediaPlayer?.start()
