...
import com.example.hango.databinding.ActivityB21Binding

class B21Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB21Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB21Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B22Activity::class.java)
