...
import com.example.hango.databinding.ActivityB22Binding

class B22Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB22Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB22Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("B23", 23)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoBActivity::class.java)
                intent.putExtra("errores", errores.toTypedArray())
                startActivity(intent)
            } else {
                val intent = Intent(this, BFinalActivity::class.java)
                startActivity(intent)
            }
            finish()
        }
