...
import com.example.hango.databinding.ActivityB3Binding

class B3Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB3Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B4Activity::class.java)
