...
import com.example.hango.databinding.ActivityB5Binding
import com.example.hango.leccion1.A6Activity

class B5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, B6Activity::class.java)
