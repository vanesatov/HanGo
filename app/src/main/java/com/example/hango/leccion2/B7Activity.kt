...
import com.example.hango.databinding.ActivityB7Binding

class B7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB7Binding.inflate(layoutInflater)
