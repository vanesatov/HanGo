...
import com.example.hango.databinding.ActivityB9Binding

class B9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityB9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityB9Binding.inflate(layoutInflater)
