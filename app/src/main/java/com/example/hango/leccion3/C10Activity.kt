...
import com.example.hango.databinding.ActivityC10Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC10Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC10Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C11Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_kwa)
        mediaPlayer?.start()
