...
import com.example.hango.databinding.ActivityC12Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C12Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC12Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC12Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C13Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_kkyu)
        mediaPlayer?.start()
