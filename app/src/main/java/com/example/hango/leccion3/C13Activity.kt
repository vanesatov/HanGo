...
import com.example.hango.databinding.ActivityC13Binding

class C13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityC13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, C14Activity::class.java)
