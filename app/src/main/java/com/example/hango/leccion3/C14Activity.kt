...
import com.example.hango.databinding.ActivityC14Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC14Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC14Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C15Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_kke)
        mediaPlayer?.start()
