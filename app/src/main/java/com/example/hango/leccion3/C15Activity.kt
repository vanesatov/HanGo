...
import com.example.hango.databinding.ActivityC15Binding

class C15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityC15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, C16Activity::class.java)
