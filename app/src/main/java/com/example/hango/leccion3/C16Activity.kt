...
import com.example.hango.databinding.ActivityC16Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC16Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC16Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C17Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_kkwo)
        mediaPlayer?.start()
