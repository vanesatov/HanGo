...
import com.example.hango.databinding.ActivityC17Binding

class C17Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityC17Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, C18Activity::class.java)
