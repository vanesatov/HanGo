...
import com.example.hango.databinding.ActivityC2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C2Activity : BaseLeccionActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C3Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_geo)
        mediaPlayer?.start()
