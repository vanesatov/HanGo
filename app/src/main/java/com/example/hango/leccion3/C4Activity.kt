...
import com.example.hango.databinding.ActivityC4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C5Activity::class.java)
