...
import com.example.hango.databinding.ActivityC6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_ki)
        mediaPlayer?.start()
