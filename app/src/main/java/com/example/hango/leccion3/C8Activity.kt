...
import com.example.hango.databinding.ActivityC8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class C8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityC8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, C9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_ko)
        mediaPlayer?.start()
