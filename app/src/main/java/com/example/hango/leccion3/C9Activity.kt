...
import com.example.hango.databinding.ActivityC9Binding

class C9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityC9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityC9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, C10Activity::class.java)
