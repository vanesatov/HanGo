package com.example.hango.leccion4
...
import com.example.hango.databinding.ActivityD11Binding


class D11Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD11Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D12Activity::class.java)
