...
import com.example.hango.databinding.ActivityD13Binding

class D13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D14Activity::class.java)
