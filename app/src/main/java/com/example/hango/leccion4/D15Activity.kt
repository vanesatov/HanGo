...
import com.example.hango.databinding.ActivityD15Binding

class D15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D16Activity::class.java)
