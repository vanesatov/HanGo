...
import com.example.hango.databinding.ActivityD16Binding


class D16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD16Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("D17", 17)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoDActivity::class.java)
                intent.putExtra("errores", errores.toTypedArray())
                startActivity(intent)
            } else {
                val intent = Intent(this, DFinalActivity::class.java)
                startActivity(intent)
            }
            finish()
        }
