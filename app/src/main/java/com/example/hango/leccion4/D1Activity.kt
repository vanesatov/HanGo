...
import com.example.hango.databinding.ActivityD1Binding
...
class D1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityD1Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityD1Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, D2Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_da)
        mediaPlayer?.start()
    ...
    private fun marcarLeccionComoAbiertaSiEsPrimeraVez() {
        ...
        val dbRef = FirebaseDatabase.getInstance().reference
            .child("usuarios").child(uid).child("lecciones").child("leccion4")
