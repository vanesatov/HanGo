...
import com.example.hango.databinding.ActivityD2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class D2Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD2Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityD2Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, D3Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_di)
        mediaPlayer?.start()
