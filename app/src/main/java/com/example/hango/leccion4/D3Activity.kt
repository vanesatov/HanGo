...
import com.example.hango.databinding.ActivityD3Binding

class D3Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD3Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D4Activity::class.java)
