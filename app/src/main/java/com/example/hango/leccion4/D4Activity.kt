...
import com.example.hango.databinding.ActivityD4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class D4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityD4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, D5Activity::class.java)
