...
import com.example.hango.databinding.ActivityD5Binding

class D5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D6Activity::class.java)
