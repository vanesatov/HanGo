...
import com.example.hango.databinding.ActivityD6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class D6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityD6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, D7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_te)
        mediaPlayer?.start()
