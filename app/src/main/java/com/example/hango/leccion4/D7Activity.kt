...
import com.example.hango.databinding.ActivityD7Binding

class D7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD7Binding.inflate(layoutInflater)
        ...
        binding.btnReproducirAudio.setOnClickListener {
            mediaPlayer?.release()
            mediaPlayer = MediaPlayer.create(this, R.raw.letra_du)
            mediaPlayer?.start()
        }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D8Activity::class.java)
