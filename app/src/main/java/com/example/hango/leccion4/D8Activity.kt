...
import com.example.hango.databinding.ActivityD8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class D8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityD8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, D9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_teo)
        mediaPlayer?.start()
