...
import com.example.hango.databinding.ActivityD9Binding

class D9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityD9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityD9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, D10Activity::class.java)
