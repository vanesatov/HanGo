...
import com.example.hango.databinding.ActivityE11Binding

class E11Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE11Binding.inflate(layoutInflater)
        ...
        binding.audioIcon1.setOnClickListener {
            reproducirSonido(R.raw.letra_teu)
        ...
        binding.audioIcon3.setOnClickListener {
            reproducirSonido(R.raw.letra_tto)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E12Activity::class.java)
