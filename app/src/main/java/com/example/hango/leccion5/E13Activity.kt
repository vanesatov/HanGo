...
import com.example.hango.databinding.ActivityE13Binding

class E13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E14Activity::class.java)
