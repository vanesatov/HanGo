...
import com.example.hango.databinding.ActivityE15Binding

class E15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E16Activity::class.java)
