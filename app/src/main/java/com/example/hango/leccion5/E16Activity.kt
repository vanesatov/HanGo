...
import com.example.hango.databinding.ActivityE16Binding

class E16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE16Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("E17", 17)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoEActivity::class.java)
                intent.putExtra("errores", errores.toTypedArray())
                startActivity(intent)
            } else {
                val intent = Intent(this, EFinalActivity::class.java)
                startActivity(intent)
            }
            finish()
        }
