...
import com.example.hango.databinding.ActivityE1Binding
...
class E1Activity : AppCompatActivity() {
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_ba)
        mediaPlayer?.start()
    ...
    private fun marcarLeccionComoAbiertaSiEsPrimeraVez() {
        ...
        val dbRef = FirebaseDatabase.getInstance().reference
            .child("usuarios").child(uid).child("lecciones").child("leccion5")
