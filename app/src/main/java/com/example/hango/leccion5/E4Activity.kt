...
import com.example.hango.databinding.ActivityE4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class E4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityE4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, E5Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_bi)
        mediaPlayer?.start()
