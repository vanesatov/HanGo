...
import com.example.hango.databinding.ActivityE5Binding

class E5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E6Activity::class.java)
