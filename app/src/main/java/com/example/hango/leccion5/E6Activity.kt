...
import com.example.hango.databinding.ActivityE6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class E6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityE6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, E7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_pa)
        mediaPlayer?.start()
