...
import com.example.hango.databinding.ActivityE7Binding

class E7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE7Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E8Activity::class.java)
