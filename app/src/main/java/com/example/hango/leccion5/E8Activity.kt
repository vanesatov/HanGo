...
import com.example.hango.databinding.ActivityE8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class E8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityE8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, E9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_pu)
        mediaPlayer?.start()
