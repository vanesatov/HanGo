...
import com.example.hango.databinding.ActivityE9Binding


class E9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityE9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityE9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, E10Activity::class.java)
