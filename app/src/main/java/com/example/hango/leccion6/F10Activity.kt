...
import com.example.hango.databinding.ActivityF10Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class F10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF10Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityF10Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, F11Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_sso)
        mediaPlayer?.start()
