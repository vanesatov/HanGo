...
import com.example.hango.databinding.ActivityF13Binding

class F13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityF13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, F14Activity::class.java)
