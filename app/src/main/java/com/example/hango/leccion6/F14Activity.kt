...
import com.example.hango.databinding.ActivityF14Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class F14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF14Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityF14Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, F15Activity::class.java)
