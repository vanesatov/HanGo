...
import com.example.hango.databinding.ActivityF15Binding

class F15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityF15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, F16Activity::class.java)
