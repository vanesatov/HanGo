...
import com.example.hango.databinding.ActivityF16Binding


class F16Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityF16Binding.inflate(layoutInflater)
        ...
        binding.btnComprobar.setOnClickListener {
            if (!enModoRepaso) {
                calcularYAnimarProgreso("F17", 17)
            }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (errores.isNotEmpty()) {
                val intent = Intent(this, RepasoFActivity::class.java)
