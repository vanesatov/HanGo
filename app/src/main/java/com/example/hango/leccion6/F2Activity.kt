...
import com.example.hango.databinding.ActivityF2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class F2Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF2Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityF2Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, F3Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_si)
        mediaPlayer?.start()
