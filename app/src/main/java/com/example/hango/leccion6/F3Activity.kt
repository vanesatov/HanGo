...
import com.example.hango.databinding.ActivityF3Binding

class F3Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, F4Activity::class.java)
