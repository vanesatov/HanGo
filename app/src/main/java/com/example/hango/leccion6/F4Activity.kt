...
import com.example.hango.databinding.ActivityF4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class F4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityF4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, F5Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_su)
        mediaPlayer?.start()
