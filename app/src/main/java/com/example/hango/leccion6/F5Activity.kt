...
import com.example.hango.databinding.ActivityF5Binding

class F5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityF5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, F6Activity::class.java)
