...
import com.example.hango.databinding.ActivityF8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class F8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityF8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, F9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_sseu)
        mediaPlayer?.start()
