...
import com.example.hango.databinding.ActivityF9Binding

class F9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityF9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityF9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, F10Activity::class.java)
