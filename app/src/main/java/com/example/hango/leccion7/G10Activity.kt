...
import com.example.hango.databinding.ActivityG10Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG10Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG10Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G11Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_cheu)
        mediaPlayer?.start()
