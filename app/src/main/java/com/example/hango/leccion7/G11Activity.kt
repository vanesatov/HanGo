...
import com.example.hango.databinding.ActivityG11Binding

class G11Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG11Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G12Activity::class.java)
