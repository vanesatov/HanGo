...
import com.example.hango.databinding.ActivityG12Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G12Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG12Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG12Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G13Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_jja)
        mediaPlayer?.start()
