...
import com.example.hango.databinding.ActivityG13Binding

class G13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G14Activity::class.java)
