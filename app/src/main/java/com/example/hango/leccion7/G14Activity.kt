...
import com.example.hango.databinding.ActivityG14Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG14Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG14Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G15Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_jju)
        mediaPlayer?.start()
