...
import com.example.hango.databinding.ActivityG15Binding


class G15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G16Activity::class.java)
