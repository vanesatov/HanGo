...
import com.example.hango.databinding.ActivityG2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G2Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G3Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_jo)
        mediaPlayer?.start()
