...
import com.example.hango.databinding.ActivityG3Binding

class G3Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG3Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G4Activity::class.java)
