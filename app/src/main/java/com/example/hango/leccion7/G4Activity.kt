...
import com.example.hango.databinding.ActivityG4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG4Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G5Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_jae)
        mediaPlayer?.start()
