...
import com.example.hango.databinding.ActivityG5Binding

class G5Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG5Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G6Activity::class.java)
