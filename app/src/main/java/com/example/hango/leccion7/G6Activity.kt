...
import com.example.hango.databinding.ActivityG6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_cha)
        mediaPlayer?.start()
