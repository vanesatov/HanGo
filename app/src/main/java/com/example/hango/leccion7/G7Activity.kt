...
import com.example.hango.databinding.ActivityG7Binding


class G7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG7Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G8Activity::class.java)
