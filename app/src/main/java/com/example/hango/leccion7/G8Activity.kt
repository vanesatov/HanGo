...
import com.example.hango.databinding.ActivityG8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class G8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityG8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, G9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_cheo)
        mediaPlayer?.start()
