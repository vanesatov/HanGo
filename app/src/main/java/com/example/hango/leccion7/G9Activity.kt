...
import com.example.hango.databinding.ActivityG9Binding

class G9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityG9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityG9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, G10Activity::class.java)
