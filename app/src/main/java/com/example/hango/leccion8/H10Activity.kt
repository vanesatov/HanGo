...
import com.example.hango.databinding.ActivityH10Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H10Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH10Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH10Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, H11Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_reu)
        mediaPlayer?.start()
