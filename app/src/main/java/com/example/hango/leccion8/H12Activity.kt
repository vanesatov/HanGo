...
import com.example.hango.databinding.ActivityH12Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H12Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH12Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH12Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, H13Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_ha)
        mediaPlayer?.start()
