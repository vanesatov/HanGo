...
import com.example.hango.databinding.ActivityH13Binding

class H13Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityH13Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, H14Activity::class.java)
