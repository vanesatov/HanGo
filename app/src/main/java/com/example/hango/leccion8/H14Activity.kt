...
import com.example.hango.databinding.ActivityH14Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H14Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH14Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH14Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, H15Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_hae)
        mediaPlayer?.start()
