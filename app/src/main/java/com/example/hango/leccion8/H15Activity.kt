...
import com.example.hango.databinding.ActivityH15Binding

class H15Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityH15Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, H16Activity::class.java)
