...
import com.example.hango.databinding.ActivityH4Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H4Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH4Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH4Binding.inflate(layoutInflater)
