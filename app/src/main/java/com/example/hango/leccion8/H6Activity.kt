...
import com.example.hango.databinding.ActivityH6Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H6Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH6Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH6Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, H7Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_mo)
        mediaPlayer?.start()
