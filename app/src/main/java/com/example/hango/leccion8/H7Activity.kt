...
import com.example.hango.databinding.ActivityH7Binding

class H7Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityH7Binding.inflate(layoutInflater)
        ...
        binding.btnReproducirAudio.setOnClickListener {
            mediaPlayer?.release()
            mediaPlayer = MediaPlayer.create(this, R.raw.letra_me)
            mediaPlayer?.start()
        }
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, H8Activity::class.java)
