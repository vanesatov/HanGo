...
import com.example.hango.databinding.ActivityH8Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class H8Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH8Binding
    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityH8Binding.inflate(layoutInflater)
        ...
        binding.btnSiguiente.setOnClickListener {
            val intent = Intent(this, H9Activity::class.java)
    ...
    private fun reproducirSonido() {
        mediaPlayer?.release()
        mediaPlayer = MediaPlayer.create(this, R.raw.letra_reo)
        mediaPlayer?.start()
