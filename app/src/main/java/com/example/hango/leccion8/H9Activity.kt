...
import com.example.hango.databinding.ActivityH9Binding

class H9Activity : BaseLeccionActivity() {
    private lateinit var binding: ActivityH9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityH9Binding.inflate(layoutInflater)
        ...
        binding.includeModalResultado.btnContinuar.setOnClickListener {
            ...
            if (enModoRepaso) {
                ...
                val intent = Intent(this, H10Activity::class.java)
