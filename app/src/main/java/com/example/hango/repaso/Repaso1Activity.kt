...
import com.example.hango.databinding.ActivityRepaso1Binding
import com.google.android.material.card.MaterialCardView

class Repaso1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso1Binding.inflate(layoutInflater)
