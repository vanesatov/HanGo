...
import com.example.hango.databinding.ActivityRepaso2Binding
import com.google.android.material.card.MaterialCardView

class Repaso2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso2Binding.inflate(layoutInflater)
