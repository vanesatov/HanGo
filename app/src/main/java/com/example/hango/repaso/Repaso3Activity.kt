...
import com.example.hango.databinding.ActivityRepaso3Binding
import com.google.android.material.card.MaterialCardView

class Repaso3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso3Binding.inflate(layoutInflater)
