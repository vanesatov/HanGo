...
import com.example.hango.databinding.ActivityRepaso4Binding
import com.google.android.material.card.MaterialCardView

class Repaso4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso4Binding.inflate(layoutInflater)
