...
import com.example.hango.databinding.ActivityRepaso5Binding
import com.google.android.material.card.MaterialCardView

class Repaso5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso5Binding.inflate(layoutInflater)
