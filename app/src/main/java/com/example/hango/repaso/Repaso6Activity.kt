...
import com.example.hango.databinding.ActivityRepaso6Binding
import com.google.android.material.card.MaterialCardView

class Repaso6Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso6Binding.inflate(layoutInflater)
