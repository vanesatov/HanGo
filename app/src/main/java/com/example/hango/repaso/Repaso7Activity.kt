...
import com.example.hango.databinding.ActivityRepaso7Binding
import com.google.android.material.card.MaterialCardView

class Repaso7Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso7Binding.inflate(layoutInflater)
