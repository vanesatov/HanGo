...
import com.example.hango.databinding.ActivityRepaso8Binding
import com.google.android.material.card.MaterialCardView

class Repaso8Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepaso8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepaso8Binding.inflate(layoutInflater)
