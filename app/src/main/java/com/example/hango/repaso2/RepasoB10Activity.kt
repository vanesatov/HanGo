...
import com.example.hango.databinding.ActivityRepasoB10Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB10Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB10Binding.inflate(layoutInflater)
