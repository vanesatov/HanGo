...
import com.example.hango.databinding.ActivityRepasoB1Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB1Binding.inflate(layoutInflater)
