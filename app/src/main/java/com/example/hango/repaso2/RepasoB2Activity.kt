...
import com.example.hango.databinding.ActivityRepasoB2Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB2Binding.inflate(layoutInflater)
