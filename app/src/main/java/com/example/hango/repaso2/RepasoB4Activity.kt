...
import com.example.hango.databinding.ActivityRepasoB4Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB4Binding.inflate(layoutInflater)
