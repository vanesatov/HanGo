...
import com.example.hango.databinding.ActivityRepasoB6Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB6Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB6Binding.inflate(layoutInflater)
