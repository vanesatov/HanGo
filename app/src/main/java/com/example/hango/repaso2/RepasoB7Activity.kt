...
import com.example.hango.databinding.ActivityRepasoB7Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB7Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB7Binding.inflate(layoutInflater)
