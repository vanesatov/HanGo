...
import com.example.hango.databinding.ActivityRepasoB9Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoB9Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoB9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoB9Binding.inflate(layoutInflater)
