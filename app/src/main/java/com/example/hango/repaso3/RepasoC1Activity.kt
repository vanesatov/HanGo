...
import com.example.hango.databinding.ActivityRepasoC1Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC1Binding.inflate(layoutInflater)
