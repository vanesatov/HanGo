...
import com.example.hango.databinding.ActivityRepasoC2Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC2Binding.inflate(layoutInflater)
