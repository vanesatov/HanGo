...
import com.example.hango.databinding.ActivityRepasoC3Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC3Binding.inflate(layoutInflater)
