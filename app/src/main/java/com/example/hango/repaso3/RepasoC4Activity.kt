...
import com.example.hango.databinding.ActivityRepasoC4Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC4Binding.inflate(layoutInflater)
