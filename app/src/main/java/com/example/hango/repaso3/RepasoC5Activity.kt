...
import com.example.hango.databinding.ActivityRepasoC5Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC5Binding.inflate(layoutInflater)
