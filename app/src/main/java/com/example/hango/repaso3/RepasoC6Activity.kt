...
import com.example.hango.databinding.ActivityRepasoC6Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC6Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC6Binding.inflate(layoutInflater)
