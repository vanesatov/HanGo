...
import com.example.hango.databinding.ActivityRepasoC7Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC7Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC7Binding.inflate(layoutInflater)
