...
import com.example.hango.databinding.ActivityRepasoC8Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC8Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC8Binding.inflate(layoutInflater)
