...
import com.example.hango.databinding.ActivityRepasoC9Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoC9Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoC9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoC9Binding.inflate(layoutInflater)
