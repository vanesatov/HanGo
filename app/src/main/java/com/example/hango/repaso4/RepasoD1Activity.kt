...
import com.example.hango.databinding.ActivityRepasoD1Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD1Binding.inflate(layoutInflater)
