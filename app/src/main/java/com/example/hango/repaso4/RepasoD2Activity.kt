...
import com.example.hango.databinding.ActivityRepasoD2Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD2Binding.inflate(layoutInflater)
