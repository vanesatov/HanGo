...
import com.example.hango.databinding.ActivityRepasoD3Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD3Binding.inflate(layoutInflater)
