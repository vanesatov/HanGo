...
import com.example.hango.databinding.ActivityRepasoD4Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD4Binding.inflate(layoutInflater)
