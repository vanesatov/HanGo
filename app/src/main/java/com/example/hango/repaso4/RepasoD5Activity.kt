...
import com.example.hango.databinding.ActivityRepasoD5Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD5Binding.inflate(layoutInflater)
