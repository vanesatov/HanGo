...
import com.example.hango.databinding.ActivityRepasoD6Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD6Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD6Binding.inflate(layoutInflater)
