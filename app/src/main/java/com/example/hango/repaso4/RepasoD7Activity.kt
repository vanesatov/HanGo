...
import com.example.hango.databinding.ActivityRepasoD7Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD7Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD7Binding.inflate(layoutInflater)
