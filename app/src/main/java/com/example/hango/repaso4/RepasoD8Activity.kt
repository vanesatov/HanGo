...
import com.example.hango.databinding.ActivityRepasoD8Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD8Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD8Binding.inflate(layoutInflater)
