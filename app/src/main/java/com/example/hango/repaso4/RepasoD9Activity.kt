...
import com.example.hango.databinding.ActivityRepasoD9Binding
import com.example.hango.repaso.RepasoFinalActivity
import com.google.android.material.card.MaterialCardView

class RepasoD9Activity : AppCompatActivity() {
    private lateinit var binding: ActivityRepasoD9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRepasoD9Binding.inflate(layoutInflater)
